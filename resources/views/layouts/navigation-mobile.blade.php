    ...
    <div
        ...
        <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
            <Link href="/dashboard" type="button"
                ...
                <svg class="w-5 h-5 mb-2 text-primary-700 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500"
                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path
                        d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a2 2 0 0 0 2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z" />
                </svg>
                <span
                    class="text-sm text-primary-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500">
                    Dashboard
                </span>
            </Link>
            <Link href="/dashboard/data" type="button"
            ...
            <Link href="/dashboard/riwayat-pembayaran" type="button"
