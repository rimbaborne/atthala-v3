...
@section('content')
    <section class="bg-white py-20 bg-[url('/hero-illustration.svg')]">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            <h1
                ...
                Quranic Camp Batch 2
            </h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                Kegiatan seru bareng teman, keluarga berkemah dan murojaah 30juz Al-Quran
            </p>
    ...
    <section class="py-20 bg-[url('/assets/bg/bg-dots-1.png')] bg-repeat bg-sky-600">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <img class="h-auto max-w-full rounded-lg shadow-lg" src="{{ url('/') }}/assets/tahsin/1.jpg"
                    alt="">
            </div>
            <div>
                <img class="h-auto max-w-full rounded-lg shadow-lg" src="{{ url('/') }}/assets/tahsin/2.jpg"
                    alt="">
            </div>
            <div>
                <img class="h-auto max-w-full rounded-lg shadow-lg" src="{{ url('/') }}/assets/tahsin/3.jpg"
                    alt="">
            </div>
            <div>
                <img class="h-auto max-w-full rounded-lg shadow-lg" src="{{ url('/') }}/assets/tahsin/4.jpg"
                    alt="">
            </div>
        </div>
    </section>
            ...
            <div class="flow-root max-w-3xl mx-auto mt-8 sm:mt-12 lg:mt-16">
                <div class="-my-4 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            <a href="#" class="hover:underline">Exploring the balance between customer acquisition
                                and retention</a>
                        </h3>
                    </div>
