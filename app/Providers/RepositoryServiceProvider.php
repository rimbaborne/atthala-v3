...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(\App\Repositories\Interface\UnitRepoInterface::class, \App\Repositories\UnitRepository::class);
        $this->app->bind(\App\Repositories\Interface\LevelRepoInterface::class, \App\Repositories\LevelRepository::class);
